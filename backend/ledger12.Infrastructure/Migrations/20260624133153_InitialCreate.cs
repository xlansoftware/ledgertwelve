    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrencyRates", x => new { x.FromCurrency, x.ToCurrency });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GlobalShares", x => new { x.OwnerId, x.SharedWithUserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CurrentBookId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookShares", x => new { x.BookId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalCurrency = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true),
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    IsBookClosingEntry = table.Column<bool>(type: "INTEGER", nullable: false),
                    ClosedBookId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
