...
const seedTransactions: Transaction[] = [
  { id: 'a100', value: 42.50,  category: 'Groceries',  author: 'Alice', book: 'Personal', notes: null, date: '2026-05-25T10:00:00+00:00' },
  { id: 'a101', value: 15.00,  category: 'Transport',  author: 'Alice', book: 'Personal', notes: null, date: '2026-05-25T14:30:00+00:00' },
  { id: 'a102', value: 200.00, category: 'Equipment',  author: 'Bob',   book: 'Business', notes: null, date: '2026-05-26T08:15:00+00:00' },
  { id: 'a103', value: 89.99,  category: 'Dining',     author: 'Alice', book: 'Personal', notes: null, date: '2026-05-26T19:45:00+00:00' },
  { id: 'a104', value: 1200.00,category: 'Rent',       author: 'Alice', book: 'Personal', notes: null, date: '2026-05-27T09:00:00+00:00' },
  { id: 'a105', value: 55.00,  category: 'Transport',  author: 'Bob',   book: 'Business', notes: null, date: '2026-05-27T11:00:00+00:00' },
]
...
function computeAggregates(
  ...
  const groups = new Map<string, { book: string; author: string; category: string; sumValue: number; count: number }>()

  for (const tx of filtered) {
    const key = bucketKey(tx.date) + '|' + (tx.book ?? '') + '|' + tx.author + '|' + tx.category
